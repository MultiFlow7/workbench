 ...
 *
 * @example
 * setWorkspaceCwd('/Users/alice/workspace')
 * assertInWorkspace('/Users/alice/workspace/notes/foo.md') // OK
 * assertInWorkspace('/Users/alice/workspace')              // OK（等于 cwd 自身）
 * assertInWorkspace('../../../etc/passwd')                 // throws EPERM
 * assertInWorkspace('/Users/alice/other')                  // throws EPERM
 */
